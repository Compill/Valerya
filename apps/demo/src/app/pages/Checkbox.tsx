  ...
  return (
    <Container center size="x2" dflex flexCol gap="20" justifyContent="center" py="20">
      <div dflex gap="20">
        ...
        <Checkbox scheme="neutral" size="lg" label="Hello" disabled checked={checked} onChange={() => setChecked(!checked)} />

        <Checkbox scheme="neutral" size="xl" label="Hello" checked={checked} variant="default" onChange={() => setChecked(!checked)} />
        <Checkbox size="x2" label="Hello" checked={checked} variant="default" onChange={() => setChecked(!checked)} />
        <Checkbox size="x2" label="Hello" disabled checked={checked} variant="default" onChange={() => setChecked(!checked)} />
      </div>
      ...
      <div dflex gap="20">
        ...
        <Checkbox scheme="neutral" corners="circle" size="x2" label="Hello" disabled checked={checked} variant="outline" onChange={() => setChecked(!checked)} />
      </div>
